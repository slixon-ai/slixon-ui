...
function SvgCouponStar(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 28 24" fill="none" {...props}>
      <g filter="url(#coupon_star_svg__filter0_bdi_319_172)">
        <mask id="coupon_star_svg__a" fill="#fff">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <path
          ...
          clipRule="evenodd"
          d="M4 8a4 4 0 014-4h12a4 4 0 014 4v1.223c0 .19-.135.35-.315.413a2.501 2.501 0 000 4.728c.18.062.315.223.315.413V16a4 4 0 01-4 4H8a4 4 0 01-4-4v-1.223c0-.19.135-.35.315-.413a2.501 2.501 0 000-4.728A.449.449 0 014 9.223V8z"
          fill="url(#coupon_star_svg__paint0_linear_319_172)"
        ...
        <path
          ...
          fill="url(#coupon_star_svg__paint1_linear_319_172)"
          fillOpacity={0.7}
          mask="url(#coupon_star_svg__a)"
        />
      </g>
      <g filter="url(#coupon_star_svg__filter1_d_319_172)">
        <path
          d="M13.601 8.528a.5.5 0 01.798 0l.99 1.312a.5.5 0 00.236.171l1.553.537a.5.5 0 01.247.759l-.941 1.347a.5.5 0 00-.09.277l-.03 1.643a.5.5 0 01-.646.47l-1.572-.48a.499.499 0 00-.292 0l-1.572.48a.5.5 0 01-.645-.47l-.03-1.643a.5.5 0 00-.09-.277l-.942-1.347a.5.5 0 01.247-.76l1.553-.536a.5.5 0 00.236-.171l.99-1.312z"
          fill="#2AEAE7"
        />
      </g>
      <defs>
        <linearGradient
          id="coupon_star_svg__paint0_linear_319_172"
          x1={-2.5}
          y1={-2.4}
          x2={27.119}
          y2={30.621}
        ...
        <linearGradient
          id="coupon_star_svg__paint1_linear_319_172"
          x1={4.5}
          y1={6.4}
          x2={18.633}
          y2={21.543}
        ...
        <filter
          id="coupon_star_svg__filter0_bdi_319_172"
          x={0}
          y={0}
          width={28}
          height={24}
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_319_172"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            in2="effect1_backgroundBlur_319_172"
            result="effect2_dropShadow_319_172"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_319_172"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend in2="shape" result="effect3_innerShadow_319_172" />
        </filter>
        <filter
          id="coupon_star_svg__filter1_d_319_172"
          x={8.485}
          y={6.33}
          width={11.031}
          height={10.736}
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_319_172"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect1_dropShadow_319_172"
            result="shape"
          />
        </filter>
      </defs>

...
function SvgCoupon2(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 28 24" fill="none" {...props}>
      <g filter="url(#coupon2_svg__filter0_bdi_319_173)">
        <mask id="coupon2_svg__a" fill="#fff">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <path
          ...
          clipRule="evenodd"
          d="M4 8a4 4 0 014-4h12a4 4 0 014 4v1.223c0 .19-.135.35-.315.413a2.501 2.501 0 000 4.728c.18.062.315.223.315.413V16a4 4 0 01-4 4H8a4 4 0 01-4-4v-1.223c0-.19.135-.35.315-.413a2.501 2.501 0 000-4.728A.449.449 0 014 9.223V8z"
          fill="url(#coupon2_svg__paint0_linear_319_173)"
        ...
        <path
          ...
          fill="url(#coupon2_svg__paint1_linear_319_173)"
          fillOpacity={0.7}
          mask="url(#coupon2_svg__a)"
        />
      </g>
      <g filter="url(#coupon2_svg__filter1_d_319_173)">
        <path
          d="M16.25 7a.75.75 0 001.5 0h-1.5zm1.5-2v-.75h-1.5V5h1.5zm-1.5 0v2h1.5V5h-1.5z"
          fill="#2AEAE7"
        />
      </g>
      <g filter="url(#coupon2_svg__filter2_d_319_173)">
        <path
          d="M17 13.5v-3"
          stroke="#2AEAE7"
          strokeWidth={1.5}
      ...
      <g filter="url(#coupon2_svg__filter3_d_319_173)">
        <path
          d="M16.25 19v.75h1.5V19h-1.5zm1.5-2a.75.75 0 00-1.5 0h1.5zm-1.5 0v2h1.5v-2h-1.5z"
          fill="#2AEAE7"
        />
      </g>
      <defs>
        <filter
          id="coupon2_svg__filter0_bdi_319_173"
          x={0}
          y={0}
          width={28}
          height={24}
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_319_173"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            in2="effect1_backgroundBlur_319_173"
            result="effect2_dropShadow_319_173"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_319_173"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend in2="shape" result="effect3_innerShadow_319_173" />
        </filter>
        <filter
          id="coupon2_svg__filter1_d_319_173"
          x={14.25}
          y={2.25}
          width={5.5}
          height={7.5}
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_319_173"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect1_dropShadow_319_173"
            result="shape"
          />
        </filter>
        <filter
          id="coupon2_svg__filter2_d_319_173"
          x={14.25}
          y={7.75}
          width={5.5}
          height={8.5}
        ...
        <filter
          id="coupon2_svg__filter3_d_319_173"
          x={14.25}
          y={14.25}
          width={5.5}
          height={7.5}
        ...
        <linearGradient
          id="coupon2_svg__paint0_linear_319_173"
          x1={-2.5}
          y1={-2.4}
          x2={27.119}
          y2={30.621}
        ...
        <linearGradient
          id="coupon2_svg__paint1_linear_319_173"
          x1={4.5}
          y1={6.4}
          x2={18.633}
          y2={21.543}

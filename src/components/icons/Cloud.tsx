...
function SvgCloud(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 28 24" fill="none" {...props}>
      <g
        filter="url(#cloud_svg__filter0_bdi_319_186)"
      ...
      >
        <path
          ...
          fill="url(#cloud_svg__paint0_linear_319_186)"
        />
        <path
          ...
          stroke="url(#cloud_svg__paint1_linear_319_186)"
          strokeOpacity={0.7}
          strokeWidth={0.25}
          strokeLinecap="round"
        />
      ...
      <defs>
        <linearGradient
          id="cloud_svg__paint0_linear_319_186"
          x1={-2.5}
          y1={1.111}
          x2={18.724}
          y2={32.087}
        ...
        <linearGradient
          id="cloud_svg__paint1_linear_319_186"
          x1={4.5}
          y1={7.833}
          x2={14.731}
          y2={22.183}
        ...
        <filter
          id="cloud_svg__filter0_bdi_319_186"
          x={0}
          y={2}
          width={28}
          height={20.222}
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_319_186"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            in2="effect1_backgroundBlur_319_186"
            result="effect2_dropShadow_319_186"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_319_186"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend in2="shape" result="effect3_innerShadow_319_186" />
        </filter>
      </defs>
    </svg>
  );

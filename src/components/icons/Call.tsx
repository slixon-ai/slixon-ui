...
function SvgCall(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 26 26" fill="none" {...props}>
      <g
        filter="url(#call_svg__filter0_bdi_319_212)"
      ...
      >
        <path
          ...
          fill="url(#call_svg__paint0_linear_319_212)"
        />
        <path
          ...
          stroke="url(#call_svg__paint1_linear_319_212)"
          strokeOpacity={0.7}
          strokeWidth={0.25}
        />
      </g>
      <defs>
        <linearGradient
          id="call_svg__paint0_linear_319_212"
          x1={-1.85}
          y1={-3.2}
          x2={31.45}
          y2={26.5}
        ...
        <linearGradient
          id="call_svg__paint1_linear_319_212"
          x1={4.45}
          y1={6.7}
          x2={20.2}
          y2={20.2}
        ...
        <filter
          id="call_svg__filter0_bdi_319_212"
          x={0}
          y={0}
          width={26}
          height={26}
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_319_212"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend
            in2="effect1_backgroundBlur_319_212"
            result="effect2_dropShadow_319_212"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_319_212"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feBlend in2="shape" result="effect3_innerShadow_319_212" />
        </filter>
      </defs>
    </svg>
  );
